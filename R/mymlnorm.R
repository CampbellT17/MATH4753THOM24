...
#' @param labcex label character expansion factor
#'
#' @return This function makes a maximum likelihood function for two parameters
#' @export
#'
#' @examples
...
mymlnorm=function(x,mu,sig,lwd,labcex){  #x sample vector
  ...
  return(list(x=x,coord=coord,maxl=maxl,mu_hat=muest,sig_hat=sigest))
}
